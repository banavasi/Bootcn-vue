...
export const AsLink: Story = {
  ...
  render: (args: any) => ({
    ...
    template:
      '<Button v-bind="args"><a href="/example" style="color: inherit; text-decoration: none;">{{ args.default }}</a></Button>',
  }),
  parameters: {
    docs: {
      description: {
        story:
          "The `asChild` prop allows the Button to compose its functionality onto a child element like an anchor tag.",
      },
    },
  },
};
